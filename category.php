...
<head>
    ...
    <title>Sola News | Categories</title>
</head>
...
<body>
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Спорт</a></li>
            <li class="breadcrumb-item active">Смешанные единоборства</li>
        </ul>
    </div>
    ...
    <main>
        ...
        <section class="section-category">
                            ...
                            <div class="col-12">
                                <div class="catalogBtn">
                                    <div class="catalogBtn__item">
                                        <a class="mybtn mybtn__green" href="category.html">Законодательство</a>
                                    </div>
                                    <div class="catalogBtn__item">
                                        <a class="mybtn mybtn__green" href="category.html">Политика</a>
                                    </div>
                                    <div class="catalogBtn__item">
                                        <a class="mybtn mybtn__green" href="category.html">Финансы</a>
                                    </div>
                                    <div class="catalogBtn__item">
                                        <a class="mybtn mybtn__green" href="category.html">Бизнес</a>
                                    </div>
                                    <div class="catalogBtn__item">
                                        <a class="mybtn mybtn__green" href="category.html">Политика</a>
                                    </div>
                                    ...
                                    <div class="catalogBtn__item active">
                                        <a class="mybtn mybtn__green" href="category.html">Законодательство</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            <div class="news__viewed d-md-none d-lg-block d-block"><i class="fas fa-eye"></i> 133
                                            </div>
                                    ...
                                    <div class="col-md-7 col-lg-12">
                                        <div class="news news__bottom">
                                            <div class="news__viewed mb-0 d-none d-md-block d-lg-none"><i class="fas fa-eye"></i> 133</div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/43/700/400">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/66/1900/1600">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/69/690/690">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/14/300/200">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <div class="news__date mr-1">17 октября</div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/55/1000/200">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/1/900/600">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/3/500/350">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/36/200/100">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <div class="news__date mr-1">17 октября</div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/234/900/600">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/64/900/600">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-lg-12">
                                        <div class="news news__bottom">
                                            ...
                                            <div class="news__img d-block">
                                                <a href="news-item.html">
                                                    <img class="newsImg__mini" src="https://picsum.photos/id/24/900/600">
                                                </a>
                                            </div>
                                            <div class="my-2 news__dates">
                                                <!-- <div class="news__date mr-1">17 октября</div> -->
            ...
            <div class="container rek-container">
                <div class="rek">
                    <div class="rek__big d-none d-md-block">
                        <img class="img-fluid" src="img/rek1_3.png" alt="Rek">
                    </div>
                    <div class="rek__vertical d-block d-md-none">
