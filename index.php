...
?>   
    ...
    <main>
        ...
        <section class="section-news" id="news">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h1 class="section__title"><a href="category-item.php">Новости</a></h1>
                        ...
                        <div class="news news__top">
                            ...
                            <div class="news__img">
                                ...
                                <div class="news__icon">
                                    <img src="img/news_icon.png" alt="news_icon">
                                </div>
                            </div>
                            ...
                            <div class="news__content mt-md-3 mt-1">
                                ...
                                <div class="d-flex align-items-center py-2">
                                    <div class="news__category mr-2">
                                        <span><a href="category.php">Политика</a></span>
                                        <span><a href="category.php">Законодательство</a></span>
                                        <span><a href="category.php">Спорт</a></span>
                                    </div>
                                </div>
                                            ...
                                            <div class="news__content mt-0 mt-md-0 mt-lg-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="news__category mr-2">
                                                        <span><a href="category.php">Политика</a></span>
                                                        <span><a href="category.php">Спорт</a></span>
                                                        <span><a href="category.php">Технологии</a></span>
                                                    </div>
                                                </div>
        ...
        <section class="section-news" id="sport">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">Спорт</a></h2>
            ...
            <div class="container rek-container">
                <div class="rek">
                    <div class="rek__big d-none d-md-block">
                        <img class="img-fluid" src="img/rek1_5.png" alt="Rek">
                    </div>
                    <div class="rek__vertical d-block d-md-none">
                        <img class="w-100 h-auto" src="img/rek5.png" alt="Rek">
                    </div>
        ...
        <section class="section-news" id="technology">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">Технологии</a></h2>
                    <!-- Filter -->
                    <section class="section-filter">
                        <div class="filter">
                            <div class="filter__item">
            ...
            <div class="container rek-container">
                <div class="rek">
                    ...
                    <div class="rek__vertical d-block d-md-none">
                        <img class="w-100 h-auto" src="img/rek3.png" alt="Rek">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="swiper-slide">
                            <div class="news__sliders">
                                <div class="news news__slider">
                                    <div class="news__img">
                                        <a href="news-item.php">
                                            <img class="newsImg__slider" src="https://picsum.photos/id/2/900/600">
                                        </a>
                                    </div>
                                    <div class="my-2 news__dates">
                                        <div class="news__date mr-1">17 октября</div>
                        ...
                        <div class="swiper-slide">
                            <div class="news__sliders">
                                <div class="news news__slider">
                                    <div class="news__img">
                                        <a href="news-item.php">
                                            <img class="newsImg__slider" src="https://picsum.photos/id/32/300/200">
                                        </a>
                                    </div>
                                    <div class="my-2 news__dates">
                                        <div class="news__date mr-1">17 октября</div>
        ...
        <section class="section-news" id="auto">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">Авто</a></h2>
                    <!-- Filter -->
                    <section class="section-filter">
                        <div class="filter">
                            <div class="filter__item">
        ...
        <section class="section-news" id="world">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">В мире</a></h2>
                    <!-- Filter -->
                    <section class="section-filter">
                        <div class="filter">
                            <div class="filter__item">
        ...
        <section class="section-news" id="science">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">Наука</a></h2>
                    <!-- Filter -->
                    <section class="section-filter">
                        <div class="filter">
                            <div class="filter__item">
            ...
            <div class="container rek-container">
                <div class="rek">
                    <div class="rek__big d-none d-md-block">
                        <img class="img-fluid" src="img/rek1_2.png" alt="Rek">
                    </div>
                    <div class="rek__vertical d-block d-md-none">
                        <img class="w-100 h-auto" src="img/rek4.png" alt="Rek">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-news" id="town">
            <div class="container">
                <div class="d-flex align-items-md-center justify-content-between flex-md-row flex-column">
                    <h2 class="section__title"><a href="category-item.php">Город</a></h2>
                    <!-- Filter -->
                    <section class="section-filter">
                        <div class="filter">
                            <div class="filter__item">
